<?php
    ...
    try{
        ...
        $stmt->bind_param("isssss", $_POST['city_id'], $_POST['name'], $_POST['surname'], $_POST['email1'], $pass, $_POST['birthday']); // isssss -> inteager, string, string, string, string, string, string
        $stmt->execute();
