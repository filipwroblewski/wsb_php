...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2022 at 09:19 AM
...
INSERT INTO `users` (`id`, `city_id`, `name`, `surname`, `birthday`, `role`, `created_at`, `email`, `pass`) VALUES
(1, 0, '', '', '0000-00-00', 'user', '2022-11-23 08:23:55', '', ''),
(2, 1, 'jan', 'nowak', '2022-11-22', 'user', '2022-11-23 09:08:37', 'e1', 'p1'),
(52, 1, 'bob', 'bobson', '2022-12-15', 'user', '2022-12-07 08:43:15', 'a@wp.pl', 'abc'),
(54, 17, 'b', 'b', '2022-12-09', 'user', '2022-12-07 09:05:44', 'b@wp.pl', '$argon2id$v=19$m=65536,t=4,p=1$ZzJjdHM0ZTlhUFBCek0zUg$YIFioJeNhQzHefFovC6tzmnojOyTSgsG77DVXkpBeMs');
